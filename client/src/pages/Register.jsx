    ...
    return (
        <section className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
            <div className="flex flex-col lg:flex-row w-full max-w-4xl bg-white rounded-lg shadow-xl overflow-hidden">
                {/* Left Side - Branding */}
                <div className="w-full lg:w-1/2 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-green-200 via-green-100 to-gray-50 p-8 flex flex-col justify-center items-center lg:items-start rounded-t-lg lg:rounded-l-lg lg:rounded-t-none">
                    ...
                    <p className="text-gray-500 mb-6 text-center lg:text-left">Join over 10,000+ happy shoppers</p>
                    <div className="space-y-2 text-gray-600 text-center lg:text-left">
                        <p className="flex items-center justify-center lg:justify-start">
                            <span className="mr-2 text-green-600">🛡️</span> Secure Shopping - Protected by industry-leading encryption
                        </p>
                        <p className="flex items-center justify-center lg:justify-start">
                            <span className="mr-2 text-green-600">🚚</span> Fast Delivery - 90% of orders delivered next day
                        </p>
                        <p className="flex items-center justify-center lg:justify-start">
                            <span className="mr-2 text-green-600">👥</span> 24/7 Support - Our team is always here to help you
                        </p>
                    </div>
                </div>
